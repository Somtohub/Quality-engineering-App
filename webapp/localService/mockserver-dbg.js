...
sap.ui.define([
	...
	var _localUriMap = {
		"QM_QLTYENGINEER_OVP_ANNO_MDL": "QM_QLTYENGINEER_OVP_ANNO_MDL"
	};
	...
	return {
		...
		init: function () {
			...
			var oUriParameters = jQuery.sap.getUriParameters(),
				...
				sManifestUrl = sPath + "/manifest.json",
				sEntity = "C_QltyEngineerOVP",
				sErrorParam = oUriParameters.get("errorType"),
				iErrorCode = sErrorParam === "badRequest" ? 400 : 500,
				oManifest = jQuery.sap.syncGetJSON(sManifestUrl).data,
				oDataSource = oManifest["sap.app"].dataSources,
				oMainDataSource = oDataSource.QM_QLTYENGINEER_OVP_SRV,
